...
func main() {
	...
	auth.Use(authMiddleware.MiddlewareFunc())
	{
		...
		auth.GET("/mahasiswa", controllers.MahasiswaTampil)
		auth.POST("/mahasiswa", controllers.MahasiswaTambah)
		auth.PUT("/mahasiswa/:nim", controllers.MahasiswaUbah)
		auth.DELETE("/mahasiswa/:nim", controllers.MahasiswaHapus)

	}

	r.GET("/", func(c *gin.Context) {
		c.JSON(http.StatusOK, gin.H{"data": "Unervitas API"})
	})
